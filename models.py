...
class Employee(models.Model):
    ...
    username = models.IntegerField(db_column='DepartmentID', blank=True, null=True)  # Field name made lowercase.
    password= models.IntegerField(db_column='Age', blank=True, null=True)  # Field name made lowercase.
